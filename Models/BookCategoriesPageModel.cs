...
namespace Mehno_Gavril_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Mehno_Gavril_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Mehno_Gavril_Lab8Context context,
